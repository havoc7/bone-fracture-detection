...
# load the models when import "predictions.py" from the files created earlier
model_elbow_frac = tf.keras.models.load_model("/content/Bone-Fracture-Detection/Dataset/weights/ResNet50_Elbow_frac.h5")
model_hand_frac = tf.keras.models.load_model("/content/Bone-Fracture-Detection/Dataset/weights/ResNet50_Hand_frac.h5")
model_shoulder_frac = tf.keras.models.load_model("/content/Bone-Fracture-Detection/Dataset/weights/ResNet50_Shoulder_frac.h5")
model_parts = tf.keras.models.load_model("/content/Bone-Fracture-Detection/Dataset/weights/ResNet50_BodyParts.h5")
