...
def trainPart(part):
    ...
    THIS_FOLDER = os.path.dirname(os.path.abspath("/content/Bone-Fracture-Detection/Dataset/train_valid"))
    ...
    # save model to this path which results in 3 individual models used in prediction code (line 6,7,8)
